        ...
        <div className="content flex items-center">
          <div className="info flex-1">
            ...
            <p className="hero-text text-lg">
              ...
              platform , Multiple sellers, in one big store, Products and
              choices, galore and more! From clothes to gadgets, all in one
              space, Multi-vendor e-commerce, setting the pace!
            </p>
          </div>
